...
public class Pattern_Finding_Comparison {
	...
	public static void main(String[] args) throws Exception {
		File f = new File(
				"C:\\Users\\SIP2LOL\\Documents\\MyTool\\Data\\working_gateways\\gateway_207010373\\2013\\09\\output");
		BufferedWriter bw = new BufferedWriter(
				new FileWriter(
						"C:\\Users\\SIP2LOL\\Documents\\MyTool\\Data\\working_gateways\\gateway_207010373\\2013\\09\\output\\out_gt207010373_sep2013_60ts_vis_Pattern1.csv"));
		...
		for (File file : files) {
			...
			if (fname.contains("__") && fname.contains("_60ts_")) {
				String afname = fname.split("__")[0] + "_Actual.csv";
